...
class HasOpenedAutomationMail implements Condition
{
    ...
    {
        return (string) __('mailcoach - Has opened automation mail');
    }
    ...
    public static function getDescription(array $data): string
    {
        ...
        return (string) __('mailcoach - :mail', ['mail' => static::getAutomationMailClass()::find($data['automation_mail_id'])->name]);
    }
