...
class UpdateAutomationMailAction
{
    ...
    public function execute(AutomationMail $automationMail, array $attributes): AutomationMail
    {
        $automationMail->fill([
            ...
            'track_opens' => $attributes['track_opens'] ?? config('mailcoach.automation.default_settings.track_opens', false),
            'track_clicks' => $attributes['track_clicks'] ?? config('mailcoach.automation.default_settings.track_clicks', false),
