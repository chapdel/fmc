...
trait InteractsWithContentItems
{
    ...
    public function openRate(): int
    {
        ...
        return round($this->uniqueOpenCount() / $this->sentToNumberOfSubscribers(), 4) * 10_000;
    }
    ...
    public function clickRate(): int
    {
        ...
        return round($this->uniqueClickCount() / $this->sentToNumberOfSubscribers(), 4) * 10_000;
    }
    ...
    public function unsubscribeRate(): int
    {
        ...
        return round($this->unsubscribeCount() / $this->sentToNumberOfSubscribers(), 4) * 10_000;
    }
    ...
    public function bounceRate(): int
    {
        ...
        return round($this->bounceCount() / $this->sentToNumberOfSubscribers(), 4) * 10_000;
    }
}
