...
namespace Spatie\Mailcoach\Domain\Audience\Livewire;
...
class EmailListStatistics extends Component
{
    ...
    public function render(): View
    {
        ...
        return view('mailcoach::app.emailLists.partials.statistics', [
