...
class UpdateCampaignAction
{
    ...
    public function execute(Campaign $campaign, array $attributes, Template $template = null): Campaign
    {
        ...
        $campaign->fill([
            ...
            'track_opens' => $attributes['track_opens'] ?? config('mailcoach.campaigns.default_settings.track_opens'),
            'track_clicks' => $attributes['track_clicks'] ?? config('mailcoach.campaigns.default_settings.track_clicks'),
            'utm_tags' => $attributes['utm_tags'] ?? config('mailcoach.campaigns.default_settings.utm_tags'),
