...
Route::prefix('campaigns')->group(function () {
    ...
    Route::prefix('{mc_campaign}')->group(function () {
        ...
        Route::get('clicks/{mc_campaignLink}', '\\'.Mailcoach::getLivewireClass('campaign-link-clicks', \Spatie\Mailcoach\Livewire\Campaigns\CampaignLinkClicksComponent::class))->name('mailcoach.campaigns.link-clicks');
...
Route::prefix('email-lists')->group(function () {
    ...
    Route::prefix('{mc_emailList}')->group(function () {
        ...
        Route::prefix('subscribers')->group(function () {
            ...
            Route::get('{mc_subscriber}', '\\'.Mailcoach::getLivewireClass('subscriber', \Spatie\Mailcoach\Livewire\Audience\SubscriberComponent::class))->name('mailcoach.emailLists.subscriber.details');
        });
        ...
        Route::prefix('tags')->group(function () {
            ...
            Route::get('{mc_tag}', '\\'.Mailcoach::getLivewireClass('tag', \Spatie\Mailcoach\Livewire\Audience\TagComponent::class))->name('mailcoach.emailLists.tags.edit');
        });
        ...
        Route::prefix('segments')->group(function () {
            ...
            Route::get('{mc_segment}', '\\'.Mailcoach::getLivewireClass('segment', \Spatie\Mailcoach\Livewire\Audience\SegmentComponent::class))->name('mailcoach.emailLists.segments.edit');
        });
    });
});
...
Route::prefix('automations')->group(function () {
    ...
    Route::prefix('{mc_automation}')->group(function () {
...
Route::prefix('automation-emails')->group(function () {
    ...
    Route::prefix('{mc_automationMail}')->group(function () {
        ...
        Route::get('clicks/{mc_automationMailLink}', '\\'.Mailcoach::getLivewireClass('automation-mail-link-clicks', \Spatie\Mailcoach\Livewire\Automations\AutomationMailLinkClicksComponent::class))->name('mailcoach.automations.mails.link-clicks');
...
Route::prefix('transactional-mail-log')->group(function () {
    ...
    Route::prefix('{mc_transactionalMail}')->group(function () {
...
Route::prefix('transactional-mail-templates')->group(function () {
    ...
    Route::prefix('{mc_transactionalMailTemplate}')->group(function () {
...
Route::prefix('templates')->group(function () {
    ...
    Route::get('{mc_template}', '\\'.Mailcoach::getLivewireClass('template', TemplateComponent::class))->name('mailcoach.templates.edit');
});
...
Route::prefix('settings')
    ...
    ->group(function () {
        ...
        Route::prefix('mailers')->group(function () {
            ...
            Route::get('{mc_mailer}', EditMailerComponent::class)->name('mailers.edit');
        });
        ...
        Route::prefix('webhooks')->group(function () {
            ...
            Route::get('{mc_webhook}', '\\'.Mailcoach::getLivewireClass('edit-webhook', \Spatie\Mailcoach\Livewire\Webhooks\EditWebhookComponent::class))->name('webhooks.edit');
            Route::get('{mc_webhook}/logs/{mc_webhookLog}', '\\'.Mailcoach::getLivewireClass('webhook-log', \Spatie\Mailcoach\Livewire\Webhooks\WebhookLogComponent::class))->name('webhooks.logs.show');
        });
    });
