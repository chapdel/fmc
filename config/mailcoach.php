...
return [
    ...
    'automation' => [
        'actions' => [
            ...
            \Spatie\Mailcoach\Domain\Automation\Support\AutomationActions\UnsubscribeAction::class,
        ],
        'triggers' => [
            \Spatie\Mailcoach\Domain\Automation\Support\AutomationTriggers\NoTrigger::class,
            ...
            \Spatie\Mailcoach\Domain\Automation\Support\AutomationTriggers\TagRemovedTrigger::class,
            \Spatie\Mailcoach\Domain\Automation\Support\AutomationTriggers\WebhookTrigger::class,
        ],
    ],
