...
![screenshot](/docs/laravel-mailcoach/v5/images/mailgun-domain-settings.png)
...
![screenshot](/docs/laravel-mailcoach/v5/images/mail-configuration/mailgun-copy-webhook.png)
...
![screenshot](/docs/laravel-mailcoach/v5/images/mailgun-webhooks.png)
...
![screenshot](/docs/laravel-mailcoach/v5/images/mail-configuration/mailgun-copy-webhook-signing-key.png)
...
![screenshot](/docs/laravel-mailcoach/v5/images/mail-configuration/mailgun-api-key.png)

Go to your _Mail configuration_ page in Mailcoach, and fill in the fields:

![screenshot](/docs/laravel-mailcoach/v5/images/mail-configuration/mailgun-setup-mail-config.png)
...
![Mailgun webhooks](/docs/laravel-mailcoach/v5/images/mailgun-webhooks.png)

At the domain settings you must enable click and open tracking

![Mailgun webhooks](/docs/laravel-mailcoach/v5/images/mailgun-domain-settings.png)
