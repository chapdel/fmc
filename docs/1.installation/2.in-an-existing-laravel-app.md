...
![screenshot](/images/docs/self-hosted/v6/forge.png)
...
```bash
composer require "spatie/laravel-mailcoach:^6.0"
```
...
By default, Mailcoach uses a plain textarea field to edit campaigns and templates. If you'd like to use a feature rich editor, you can [use one of the add-on packages](/docs/self-hosted/v6/using-mailcoach/choosing-an-editor/introduction).
