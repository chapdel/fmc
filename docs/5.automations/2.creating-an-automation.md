...
Mailcoach also allows you to create [custom triggers](/docs/self-hosted/v7/automations/creating-custom-triggers).
...
Mailcoach also allows you to create [custom actions](/docs/self-hosted/v7/automations/creating-custom-actions) and [custom conditions](/docs/self-hosted/v7/automations/creating-conditions).
