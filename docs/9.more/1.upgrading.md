...
You'll find the migration script [here](https://github.com/spatie/gists/blob/main/mailcoach/V7Migration.php).
...
You'll find the command [here](https://github.com/spatie/gists/blob/main/mailcoach/V7Migration.php).
