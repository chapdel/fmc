...
You can add an unsubscribe link by [adding an `{{ unsubscribeUrl }}` placeholder](/docs/self-hosted/v7/campaigns/creating-a-campaign#setting-the-content-and-using-placeholders) to the HTML of your campaign.
