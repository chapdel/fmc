...
This event will be fired as soon as someone subscribes. If [double opt-in](/docs/laravel-mailcoach/v5/audience/using-double-opt-in) is enabled on the email list someone is in the process of subscribing to, this event will be fired when the subscription is confirmed.
...
This event will be fired when somebody clicks a link in a mail. This event will only be fired for campaigns that have [click tracking](/docs/laravel-mailcoach/v5/automations/tracking-clicks) enabled.
...
After a campaign has been sent, statistics will [be calculated according to a schedule](/docs/laravel-mailcoach/v5/campaigns/viewing-statistics-of-a-sent-campaign).
