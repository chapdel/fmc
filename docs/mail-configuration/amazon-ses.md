...
![screenshot](https://mailcoach.app/images/docs/v3/app/mail-configuration/amazon-ses-iam.png)
...
![screenshot](https://mailcoach.app/images/docs/v3/app/mail-configuration/amazon-ses-programmatic-access.png)
...
![screenshot](https://mailcoach.app/images/docs/v3/app/mail-configuration/amazon-ses-permissions.png)
...
![screenshot](https://mailcoach.app/images/docs/v3/app/mail-configuration/amazon-ses-review.png)

If everything went OK, you should now be able to see your user's Access Key ID and Secret access key:

![screenshot](https://mailcoach.app/images/docs/v3/app/mail-configuration/amazon-ses-key-and-secret.png)
...
![screenshot](https://mailcoach.app/images/docs/v3/app/mail-configuration/amazon-ses-key-and-secret-in-mailcoach.png)
...
![screenshot](https://mailcoach.app/images/docs/v3/app/mail-configuration/amazon-ses-configuration-set.png)
...
![screenshot](https://mailcoach.app/images/docs/v3/app/mail-configuration/amazon-ses-destination-type.png)
...
![screenshot](https://mailcoach.app/images/docs/v3/app/mail-configuration/amazon-ses-sns-destination.png)
...
![screenshot](https://mailcoach.app/images/docs/v3/app/mail-configuration/amazon-ses-finished-config-set.png)
...
![screenshot](https://mailcoach.app/images/docs/v3/app/mail-configuration/amazon-ses-edit-sns-topic.png)
...
![screenshot](https://mailcoach.app/images/docs/v3/app/mail-configuration/amazon-ses-sns-subscription.png)
...
![screenshot](https://mailcoach.app/images/docs/v3/app/mail-configuration/amazon-ses-sns-subscription-confirmed.png)
...
![screenshot](https://mailcoach.app/images/docs/v3/app/mail-configuration/amazon-ses-final-mailcoach-mail-config.png)
