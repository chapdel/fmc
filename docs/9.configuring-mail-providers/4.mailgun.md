...
![screenshot](/images/docs/self-hosted/v5/mailgun-domain-settings.png)
...
![screenshot](/images/docs/self-hosted/v5/mail-configuration/mailgun-copy-webhook.png)
...
![screenshot](/images/docs/self-hosted/v5/mailgun-webhooks.png)
...
![screenshot](/images/docs/self-hosted/v5/mail-configuration/mailgun-copy-webhook-signing-key.png)
...
![screenshot](/images/docs/self-hosted/v5/mail-configuration/mailgun-api-key.png)

Go to your _Mail configuration_ page in Mailcoach, and fill in the fields:

![screenshot](/images/docs/self-hosted/v5/mail-configuration/mailgun-setup-mail-config.png)
...
![Mailgun webhooks](/images/docs/self-hosted/v5/mailgun-webhooks.png)

At the domain settings you must enable click and open tracking

![Mailgun webhooks](/images/docs/self-hosted/v5/mailgun-domain-settings.png)
