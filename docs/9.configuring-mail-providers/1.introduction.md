...
![screenshot](/images/docs/self-hosted/v5/mail-configuration/successful-test-mail.png)
...
![screenshot](/images/docs/self-hosted/v5/mail-configuration/transactional.png)
