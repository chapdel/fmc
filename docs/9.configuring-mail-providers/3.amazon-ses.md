...
![screenshot](/images/docs/self-hosted/v5/mail-configuration/amazon-ses-iam.png)
...
![screenshot](/images/docs/self-hosted/v5/mail-configuration/amazon-ses-programmatic-access.png)
...
![screenshot](/images/docs/self-hosted/v5/mail-configuration/amazon-ses-permissions.png)
...
![screenshot](/images/docs/self-hosted/v5/mail-configuration/amazon-ses-review.png)

If everything went OK, you should now be able to see your user's Access Key ID and Secret access key:

![screenshot](/images/docs/self-hosted/v5/mail-configuration/amazon-ses-key-and-secret.png)
...
![screenshot](/images/docs/self-hosted/v5/mail-configuration/amazon-ses-key-and-secret-in-mailcoach.png)
...
![screenshot](/images/docs/self-hosted/v5/mail-configuration/amazon-ses-configuration-set.png)
...
![screenshot](/images/docs/self-hosted/v5/mail-configuration/amazon-ses-destination-type.png)
...
![screenshot](/images/docs/self-hosted/v5/mail-configuration/amazon-ses-sns-destination.png)
...
![screenshot](/images/docs/self-hosted/v5/mail-configuration/amazon-ses-finished-config-set.png)
...
![screenshot](/images/docs/self-hosted/v5/mail-configuration/amazon-ses-edit-sns-topic.png)
...
![screenshot](/images/docs/self-hosted/v5/mail-configuration/amazon-ses-sns-subscription.png)
...
![screenshot](/images/docs/self-hosted/v5/mail-configuration/amazon-ses-sns-subscription-confirmed.png)
...
![screenshot](/images/docs/self-hosted/v5/mail-configuration/amazon-ses-final-mailcoach-mail-config.png)
...
![screenshot](/images/docs/self-hosted/v5/ses-feedback/1.create-configuration-set.png)

2. Add an SNS destination in the Event Destinations and make sure to check the event types you would like to receive

![screenshot](/images/docs/self-hosted/v5/ses-feedback/2-1-add-destination.png)

![screenshot](/images/docs/self-hosted/v5/ses-feedback/2-2-add-destination.png)

3. Create a new topic for this destination

![screenshot](/images/docs/self-hosted/v5/ses-feedback/3-create-new-topic.png)
...
![screenshot](/images/docs/self-hosted/v5/ses-feedback/4-1-create-subscription.png)

![screenshot](/images/docs/self-hosted/v5/ses-feedback/4-2-create-subscription.png)
...
![screenshot](/images/docs/self-hosted/v5/ses-feedback/5-subscription-confirmed.png)
