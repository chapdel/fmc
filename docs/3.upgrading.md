...
This version of Mailcoach uses an newer version of Unlayer. Your old templates might not be compatible. To make Unlayer templates comptabile, you might try the code mentioned in [this issue](https://github.com/spatie/laravel-mailcoach/issues/1183).
