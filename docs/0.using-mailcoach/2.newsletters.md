...
![screenshot](/images/docs/self-hosted/v5/campaigns/index.png)
...
![screenshot](/images/docs/self-hosted/v5/campaigns/creating-a-campaign-index.png)
...
![screenshot](/images/docs/self-hosted/v5/campaigns/creating-a-campaign-settings.png)
...
![screenshot](/images/docs/self-hosted/v5/campaigns/creating-a-campaign-content.png)
...
![screenshot](/images/docs/self-hosted/v5/campaigns/creating-a-campaign-delivery.png)
...
![screenshot](/images/docs/self-hosted/v5/campaigns/campaign-statistics-sending.png)
...
![screenshot](/images/docs/self-hosted/v5/campaigns/campaign-statistics-overview.png)
...
![screenshot](/images/docs/self-hosted/v5/campaigns/campaign-statistics-opens.png)

On the _Opens_ screen, you can see which subscribers have already opened your email, and when.

![screenshot](/images/docs/self-hosted/v5/campaigns/campaign-statistics-clicks.png)
...
![screenshot](/images/docs/self-hosted/v5/campaigns/campaign-statistics-unsubscribes.png)

You can also see how many people, regrettably, clicked the unsubscribe link in this campaign.

### Outbox

![screenshot](/images/docs/self-hosted/v5/campaigns/campaign-statistics-outbox.png)
...
![screenshot](/images/docs/self-hosted/v5/templates/create.png)
