...
![automations list](/images/docs/self-hosted/v5/automations/index.png)
...
![creating an automation](/images/docs/self-hosted/v5/automations/create.png)

## Settings

![automation settings](/images/docs/self-hosted/v5/automations/settings.png)
...
![automation actions](/images/docs/self-hosted/v5/automations/actions.png)
...
![automation actions](/images/docs/self-hosted/v5/automations/add-action.png)
...
![run automation](/images/docs/self-hosted/v5/automations/run.png)
...
![screenshot](/images/docs/self-hosted/v5/automations/creating-an-automation-mail-index.png)

### Settings

![screenshot](/images/docs/self-hosted/v5/automations/creating-an-automation-mail-settings.png)
...
![screenshot](/images/docs/self-hosted/v5/automations/creating-an-automation-mail-content.png)
...
![screenshot](/images/docs/self-hosted/v5/automations/creating-an-automation-mail-delivery.png)
...
![screenshot](/images/docs/self-hosted/v5/automations/automation-mail-statistics-overview.png)
...
![screenshot](/images/docs/self-hosted/v5/automations/automation-mail-statistics-opens.png)

On the _Opens_ screen, you can see which subscribers have already opened your email, and when.

![screenshot](/images/docs/self-hosted/v5/automations/automation-mail-statistics-clicks.png)
...
![screenshot](/images/docs/self-hosted/v5/automations/automation-mail-statistics-unsubscribes.png)

You can also see how many people, regrettably, clicked the unsubscribe link in this campaign.

### Outbox

![screenshot](/images/docs/self-hosted/v5/automations/automation-mail-statistics-outbox.png)
