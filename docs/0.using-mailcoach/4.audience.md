...
![screenshot](/images/docs/self-hosted/v5/lists/index.png)
...
![screenshot](/images/docs/self-hosted/v5/lists/create.png)
...
![screenshot](/images/docs/self-hosted/v5/lists/subscribers-index.png)
...
![screenshot](/images/docs/self-hosted/v5/lists/subscribers-import.png)
...
![screenshot](/images/docs/self-hosted/v5/lists/subscribers-import-page.png)
...
![screenshot](/images/docs/self-hosted/v5/lists/subscribers-import-report.png)
...
![screenshot](/images/docs/self-hosted/v5/lists/subscribers-export.png)

## Settings

### General settings

![screenshot](/images/docs/self-hosted/v5/lists/settings-general.png)
...
![screenshot](/images/docs/self-hosted/v5/lists/reports-campaign-sent.png)
...
![screenshot](/images/docs/self-hosted/v5/lists/reports-campaign-summary.png)
...
![screenshot](/images/docs/self-hosted/v5/lists/reports-list-summary.png)

### Onboarding

#### Require confirmation (double opt-in)

![screenshot](/images/docs/self-hosted/v5/lists/onboarding.png)
...
![screenshot](/images/docs/self-hosted/v5/lists/settings-landing-pages.png)
...
![screenshot](/images/docs/self-hosted/v5/lists/settings-default-confirmation.png)
...
![screenshot](/images/docs/self-hosted/v5/lists/settings-welcome-mail.png)
...
![screenshot](/images/docs/self-hosted/v5/lists/settings-confirmation-mail.png)
...
![screenshot](/images/docs/self-hosted/v5/lists/settings-default-confirmation-mail.png)
...
![screenshot](/images/docs/self-hosted/v5/lists/tags.png)
...
![screenshot](/images/docs/self-hosted/v5/lists/tags-on-subscriber.png)
...
![screenshot](/images/docs/self-hosted/v5/lists/segments.png)

When creating a campaign, you can choose to send it to an entire mailing list, or one of its segments:

![screenshot](/images/docs/self-hosted/v5/lists/segments-on-campaign.png)
