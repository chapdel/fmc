...
```shell script
$ MAILCOACH_TOKEN="your API token"
$ curl ::tenantUrl::/api/campaigns/99 \
    -H "Authorization: Bearer $MAILCOACH_TOKEN" \
    -H 'Accept: application/json' \
    -H 'Content-Type: application/json'
```
...
To update a campaign, create a `PUT` call to the `/api/campaigns/<id>` endpoint. In the example below we're updating the campaign with ID 99.

```shell script
$ MAILCOACH_TOKEN="your API token"
$ curl -X PUT ::tenantUrl::/api/campaigns/99 \
    -H "Authorization: Bearer $MAILCOACH_TOKEN" \
    -H 'Accept: application/json' \
    -H 'Content-Type: application/json' \
...
To delete a campaign, create a `DELETE` call to the `/api/campaigns/<id>` endpoint. In the example below we're deleting the campaign with ID 99.

```shell script
$ MAILCOACH_TOKEN="your API token"
$ curl -X DELETE ::tenantUrl::/api/campaigns/99 \
    -H "Authorization: Bearer $MAILCOACH_TOKEN" \
    -H 'Accept: application/json' \
    -H 'Content-Type: application/json'
```
...
To send a campaign test, create a `POST` call to the `/api/campaigns/<id>/send-test` endpoint.

```shell script
$ MAILCOACH_TOKEN="your API token"
$ curl -X POST ::tenantUrl::/api/campaigns/99/send-test \
    -H "Authorization: Bearer $MAILCOACH_TOKEN" \
    -H 'Accept: application/json' \
    -H 'Content-Type: application/json' \
...
To send a campaign, create a `POST` call to the `/api/campaigns/<id>/send` endpoint.

```shell script
$ MAILCOACH_TOKEN="your API token"
$ curl -X POST ::tenantUrl::/api/campaigns/99/send \
    -H "Authorization: Bearer $MAILCOACH_TOKEN" \
    -H 'Accept: application/json' \
    -H 'Content-Type: application/json'
```
...
To get the opens of a campaign, create a `GET` call to the `/api/campaigns/<id>/opens` endpoint.

```shell script
$ MAILCOACH_TOKEN="your API token"
$ curl ::tenantUrl::/api/campaigns/99/opens \
    -H "Authorization: Bearer $MAILCOACH_TOKEN" \
    -H 'Accept: application/json' \
    -H 'Content-Type: application/json'
```
...
```json
{
    ...
    "links": {
        "first": "::tenantUrl::/api/campaigns/2/opens?page=1",
        "last": "::tenantUrl::/api/campaigns/2/opens?page=1",
        "prev": null,
        "next": null
    },
    "meta": {
        ...
        "from": 1,
        "last_page": 1,
        "path": "::tenantUrl::/api/campaigns/2/opens",
        "per_page": 15,
        "to": 1,
        "total": 1
    }
...
To get the clicks of a campaign, create a `GET` call to the `/api/campaigns/<id>/clicks` endpoint.

```shell script
$ MAILCOACH_TOKEN="your API token"
$ curl ::tenantUrl::/api/campaigns/99/clicks \
    -H "Authorization: Bearer $MAILCOACH_TOKEN" \
    -H 'Accept: application/json' \
    -H 'Content-Type: application/json'
```
...
```json
{
    ...
    "links": {
        "first": "::tenantUrl::/api/campaigns/2/clicks?page=1",
        "last": "::tenantUrl::/api/campaigns/2/clicks?page=1",
        "prev": null,
        "next": null
    },
    "meta": {
        ...
        "from": 1,
        "last_page": 1,
        "path": "::tenantUrl::/api/campaigns/2/clicks",
        "per_page": 15,
        "to": 1,
        "total": 1
    }
...
To get the unsubscribes of a campaign, create a `GET` call to the `/api/campaigns/<id>/unsubscribes` endpoint.

```shell script
$ MAILCOACH_TOKEN="your API token"
$ curl ::tenantUrl::/api/campaigns/99/unsubscribes \
    -H "Authorization: Bearer $MAILCOACH_TOKEN" \
    -H 'Accept: application/json' \
    -H 'Content-Type: application/json'
```
...
```json
{
    ...
    "links": {
        "first": "::tenantUrl::/api/campaigns/2/unsubscribes?page=1",
        "last": "::tenantUrl::/api/campaigns/2/unsubscribes?page=1",
        "prev": null,
        "next": null
    },
    "meta": {
        ...
        "from": 1,
        "last_page": 1,
        "path": "::tenantUrl::/api/campaigns/2/unsubscribes",
        "per_page": 15,
        "to": 1,
        "total": 1
    }
