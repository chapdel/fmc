...
Mailcoach supports sending mails via Mailgun. This page contains instructions to [set up Mailgun in the standalone Mailcoach app](/docs/self-hosted/v6/configuring-mail-providers/mailgun#using-mailgun-in-the-mailcoach-standalone-app) and [in a Laravel app with `laravel-mailcoach`](/docs/self-hosted/v6/configuring-mail-providers/mailgun#handling-mailgun-feedback-in-an-existing-laravel-app).
...
![screenshot](/images/docs/self-hosted/v6/mailgun-domain-settings.png)
...
![screenshot](/images/docs/self-hosted/v6/mail-configuration/mailgun-copy-webhook.png)
...
![screenshot](/images/docs/self-hosted/v6/mailgun-webhooks.png)
...
![screenshot](/images/docs/self-hosted/v6/mail-configuration/mailgun-copy-webhook-signing-key.png)
...
![screenshot](/images/docs/self-hosted/v6/mail-configuration/mailgun-api-key.png)

Go to your _Mail configuration_ page in Mailcoach, and fill in the fields:

![screenshot](/images/docs/self-hosted/v6/mail-configuration/mailgun-setup-mail-config.png)
...
![Mailgun webhooks](/images/docs/self-hosted/v6/mailgun-webhooks.png)

At the domain settings you must enable click and open tracking

![Mailgun webhooks](/images/docs/self-hosted/v6/mailgun-domain-settings.png)
