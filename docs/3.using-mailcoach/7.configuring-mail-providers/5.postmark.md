...
Mailcoach supports sending mails via Postmark. This page contains instructions to [set up Postmark in the standalone Mailcoach app](/docs/self-hosted/v6/configuring-mail-providers/postmark#using-postmark-in-the-mailcoach-standalone-app) and [in a Laravel app with `laravel-mailcoach`](/docs/self-hosted/v6/configuring-mail-providers/postmark#handling-postmark-feedback-in-an-existing-laravel-app).
...
![screenshot](/images/docs/self-hosted/v6/postmark/postmark-webhooks.png)

On the settings screen in Postmark, you should also enable open and link tracking.

![screenshot](/images/docs/self-hosted/v6/postmark/postmark-tracking.png)
