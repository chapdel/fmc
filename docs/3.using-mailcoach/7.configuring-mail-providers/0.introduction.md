...
![screenshot](/images/docs/self-hosted/v7/mail-configuration/successful-test-mail.png)
...
![screenshot](/images/docs/self-hosted/v7/mail-configuration/transactional.png)
