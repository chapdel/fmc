...
function toggleConditionals(controller) {
  ...
  Object(_util__WEBPACK_IMPORTED_MODULE_0__["$$"])("[data-conditional-unless-".concat(controller.dataset.conditional, "]")).forEach(function (element) {
...
function bindCloseListeners(modal, _ref2) {
...
Object(_util__WEBPACK_IMPORTED_MODULE_0__["listen"])('click', '[data-modal-trigger]', function (_ref3) {
  var target = _ref3.target;
  showModal(target.dataset.modalTrigger);
});
Object(_util__WEBPACK_IMPORTED_MODULE_0__["listen"])('click', '[data-modal-confirm]', function (_ref4) {
  var target = _ref4.target;
  var modal = target.closest('[data-modal]');
  modal.dispatchEvent(new Event('confirm'));
});
Object(_util__WEBPACK_IMPORTED_MODULE_0__["listen"])('click', '[data-modal-dismiss]', function (_ref5) {
  var target = _ref5.target;
  var modal = target.closest('[data-modal]');
  modal.dispatchEvent(new Event('dismiss'));
});
Object(_util__WEBPACK_IMPORTED_MODULE_0__["listen"])('click', '[data-modal-backdrop]', function (_ref6) {
  var event = _ref6.event,
      target = _ref6.target;
...
document.addEventListener('turbolinks:load', function () {
  Object(_util__WEBPACK_IMPORTED_MODULE_0__["$$"])('[data-modal]').filter(function (modal) {
...
document.addEventListener('turbolinks:load', function () {
  var container = Object(_util__WEBPACK_IMPORTED_MODULE_0__["$"])('[data-segments]');
  ...
  var emailListSelect = Object(_util__WEBPACK_IMPORTED_MODULE_0__["$"])('[data-segments-email-list]', container);
  var entireListCheck = Object(_util__WEBPACK_IMPORTED_MODULE_0__["$"])('[name="segment"][value="entire_list"]', container);
  var segmentCheck = Object(_util__WEBPACK_IMPORTED_MODULE_0__["$"])('[name="segment"][value="segment"]', container);
  var segmentsCreate = Object(_util__WEBPACK_IMPORTED_MODULE_0__["$"])('[data-segments-create]', container);
  var segmentsCreateLink = Object(_util__WEBPACK_IMPORTED_MODULE_0__["$"])('a', segmentsCreate);
  var segmentsChoose = Object(_util__WEBPACK_IMPORTED_MODULE_0__["$"])('[data-segments-choose]', container);
  var segmentsChooseSelect = Object(_util__WEBPACK_IMPORTED_MODULE_0__["$"])('select', segmentsChoose);
