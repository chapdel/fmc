...
<nav class="navigation-main" x-data="navigation">
    ...
    <div class="px-6 flex flex-col md:flex-row md:items-center gap-x-4 gap-y-6">
        <div class="flex items-center">
            ...
            <button class="md:hidden text-white ml-auto text-2xl" x-on:click="show = !show"><i class="fa fa-bars"></i>
            </button>
        </div>
            ...
            @foreach (app(MainNavigation::class)->tree() as $index => $item)
                ...
                >
                    <a x-on:click="select"
                       ...
                       href="{{ $item['url'] }}" wire:navigate data-dirty-warn>
                    ...
                    @if(count($item['children']) > 1)
                        ...
                        <div class="navigation-dropdown md:hidden md:opacity-0">
                            @foreach ($item['children'] as $child)
                                <a x-on:click="select" class="navigation-link" href="{{ $child['url'] }}" wire:navigate
