    ...
    <x-mailcoach::help>
        ...
        To be able to send mails through Mailgun, we should authenticate with Mailgun.
            ...
            You should first <a href="https://mailgun.com" target="_blank">create an account</a> at Mailgun.
                ...
                <p>
            Next, <a target="_blank" href="https://mailcoach.app/docs/self-hosted/v7/using-mailcoach/configuring-mail-providers/mailgun#content-email-configuration">create and API key at Mailgun</a>. Make sure it has the "Mail Send" and "Tracking" permissions.
            </p>
    </x-mailcoach::help>
