    ...
    <x-mailcoach::help>
        ...
        To be able to send mails through Postmark, we should authenticate at Postmark.
            ...
            You should first <a href="https://postmarkapp.com" target="_blank">create an account</a> at Postmark.
                ...
                <p>
            Next, <a target="_blank" href="https://mailcoach.app/docs/self-hosted/v7/using-mailcoach/configuring-mail-providers/postmark#content-email-configuration">create a server API token at Postmark</a>.
            </p>
    </x-mailcoach::help>
