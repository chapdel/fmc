    ...
    <x-mailcoach::help>
        ...
        To be able to send mails through Amazon SES, we should first authenticate at Amazon.
            ...
            You should first <a href="https://aws.amazon.com" target="_blank">create an account</a> at AWS.
                ...
                <p>
            Next, <a target="_blank" href="https://mailcoach.app/docs/self-hosted/v7/using-mailcoach/configuring-mail-providers/amazon-ses#content-key-and-secret-sending-emails">create an Access Key ID and Secret Access Key</a>, and fill them in the form below.
            </p>
