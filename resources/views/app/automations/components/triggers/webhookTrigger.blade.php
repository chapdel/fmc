    <x-mailcoach::help>
    <p>
        Send an authenticated <code>POST</code> request to the following endpoint with an array of subscriber ids, make sure you've set up the <a href="https://spatie.be/docs/laravel-mailcoach/v4/api/introduction">Mailcoach API</a>.
    </p>
