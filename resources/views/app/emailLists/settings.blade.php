<x-mailcoach::layout-list :title="__('mailcoach - Settings')" :emailList="$emailList">
    <form class="form-grid" action="{{ route('mailcoach.emailLists.settings', $emailList) }}" method="POST">
        ...
        <x-mailcoach::fieldset :legend="__('mailcoach - Subscriptions')">
            ...
            <div class="form-field max-w-full">
                <div class="checkbox-group">
                    <x-mailcoach::checkbox-field dataConditional="confirmation" :label="__('mailcoach - Require confirmation')"
                                    name="requires_confirmation"
                                    :checked="$emailList->requires_confirmation"/>

                    <x-mailcoach::checkbox-field dataConditional="post" :label="__('mailcoach - Allow POST from an external form')"
        ...
        <div class="form-buttons">
            <x-mailcoach::button :label="__('mailcoach - Save list settings')"/>
        </div>
    </form>
