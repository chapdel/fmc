<div class="my-2 flex flex-wrap items-center justify-center text-gray-600 text-xs">
    ...
    <span>&nbsp;{{ __('mailcoach - by') }} <a class="link-dimmed" href="https://spatie.be">SPATIE</a></span>

    @if(Auth::check())
        <span class="mx-2">•</span>
        <a class="link-dimmed" href="https://spatie.be/docs/laravel-mailcoach" target="_blank">{{ __('mailcoach - Documentation') }}</a>
