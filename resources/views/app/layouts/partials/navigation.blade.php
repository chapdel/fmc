        ...
        <ul class="navigation">
            ...
            <x-mailcoach::navigation-item :href="route('mailcoach.campaigns')">
                <span class="icon-label">
                    ...
                    <span class="icon-label-text font-semibold">{{ __('Campaigns') }}</span>
                </span>
            </x-mailcoach::navigation-item>
            @endcan
            ...
            <x-mailcoach::navigation-item :href="route('mailcoach.automations')">
                <span class="icon-label">
                    ...
                    <span class="icon-label-text font-semibold">{{ __('Automations') }}</span>
                </span>
            </x-mailcoach::navigation-item>
        ...
        <ul class="navigation">
            <x-mailcoach::navigation-item :href="route('mailcoach.transactionalMails')">
                <span class="icon-label">
                    ...
                    <span class="icon-label-text font-semibold">{{ __('Transactional mails') }}</span>
                </span>
            </x-mailcoach::navigation-item>
