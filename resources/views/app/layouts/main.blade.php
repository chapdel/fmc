...
>
    <x-slot name="nav">
        <x-mailcoach::navigation>
            ...
            @can("viewAny", \Spatie\Mailcoach\Mailcoach::getCampaignClass())
                <x-mailcoach::navigation-group icon="far fa-envelope-open" :title="__('mailcoach - Newsletter')">
                    ...
                    <x-mailcoach::navigation-item :active="Route::is('mailcoach.templates.*')"
                                                  :href="route('mailcoach.templates')">
            ...
            @can("viewAny", \Spatie\Mailcoach\Mailcoach::getEmailListClass())
