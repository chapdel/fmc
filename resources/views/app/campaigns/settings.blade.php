<x-mailcoach::layout-campaign :title="__('mailcoach - Settings')" :campaign="$campaign">
    ...
    >
        ...
        <x-mailcoach::text-field :label="__('mailcoach - Name')" name="name" :value="$campaign->name" required  />

        <x-mailcoach::text-field :label="__('mailcoach - Subject')" name="subject" :value="$campaign->subject"  />
        ...
        <x-mailcoach::fieldset :legend="__('mailcoach - Tracking')">
            <div class="form-field">
                ...
                <div class="checkbox-group">
                    <x-mailcoach::checkbox-field :label="__('mailcoach - Someone opens this email')" name="track_opens" :checked="$campaign->track_opens" />
                    <x-mailcoach::checkbox-field :label="__('mailcoach - Links in the email are clicked')" name="track_clicks" :checked="$campaign->track_clicks" />
                </div>
            </div>
            ...
            <div class="form-field">
                ...
                <div class="checkbox-group">
                    <x-mailcoach::checkbox-field :label="__('mailcoach - Automatically add UTM tags')" name="utm_tags" :checked="$campaign->utm_tags" />
                </div>
            </div>
